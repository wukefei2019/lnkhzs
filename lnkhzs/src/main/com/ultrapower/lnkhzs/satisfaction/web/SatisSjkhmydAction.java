...
public class SatisSjkhmydAction extends BaseAction{

	private File xls;
	
	private ISatisSjkhmydService satisSjkhmydService;
	...
	public ISatisSjkhmydService getSatisSjkhmydService() {
		return satisSjkhmydService;
	}

	public void setSatisSjkhmydService(ISatisSjkhmydService satisSjkhmydService) {
		this.satisSjkhmydService = satisSjkhmydService;
	}

	public void deleteList(){
		satisSjkhmydService.deledeList(ids);
		renderText(SUCCESS);
	}
	...
	public void importExcel(){
        ...
        try {
            // 校验文件是否正确
            Workbook wb=satisSjkhmydService.checkVali(xls);
            if (wb!=null) {
                // 导入数据
                try {
                	//	traceSourceListService.removeData(date);
                		i = satisSjkhmydService.importXls(wb,user);
