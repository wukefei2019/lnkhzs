 ...
 */
@Entity
@Table(name = "ZL_KHZS_T_MAIN")
public class KhzsTMain implements ICommonModel {
    /**
     *附件_字段 
     */
    ...
    */
     ...
     * @author:
     */
    @Column(name = "EXAMPLE", unique=false ,nullable=true, insertable=true, updatable=true ,length=255 )
    ...
    */
	...
	@Column(name = "IS_SKETCH", unique=false ,nullable=true, insertable=true, updatable=true ,length=255 )
	public String getIsSketch() {
		return isSketch;
	}
	public void setIsSketch(String isSketch) {
