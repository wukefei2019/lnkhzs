 ...
 */
@Entity
@Table(name = "ZL_KHZS_QUESTIONNAIRE")
public class KhzsQuestionnaire implements ICommonModel {
    /**
	 * 
	 */
    ...
    */
     ...
     * @author:
     */
    @Column(name = "ISREWARD", unique=false ,nullable=true, insertable=true, updatable=true ,length=100 )
