 ...
 */
@Entity
@Table(name = "ZL_KHZS_QUESTION")
public class KhzsQuestion implements ICommonModel {
	...
	public KhzsQuestion(String category, String id, String options, String question, String type) {
