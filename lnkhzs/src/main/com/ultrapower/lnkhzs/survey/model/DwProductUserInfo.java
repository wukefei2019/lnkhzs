 ...
 */
@Entity
@Table(name = "ZL_KHZS_USER_INFO")
public class DwProductUserInfo  implements ICommonModel {
	/**
	 * id_字段
	 */
	private String id;
	 ...
	 * @author:
	 */
	@Column(name = "RN", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
	public String getRn() {
		return rn;
	}
	 ...
	 * @author:
	 */
	@Column(name = "IS_DAY", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
	 ...
	 * @author:
	 */
	@Column(name = "IS_MONTH", unique = false, nullable = true, insertable = true, updatable = true, length = 255)
