...
//    @Column(name="EXTENDCONTENT", unique=false, nullable=true, insertable=true, updatable=true, length=3500)
...
//	@Column(name="PUSHFLAG", unique=false, nullable=true, insertable=true, updatable=true, precision=5, scale=0)
