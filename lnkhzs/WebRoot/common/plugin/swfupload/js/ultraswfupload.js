...
UltraSWFUpload.prototype.getAndInitDownTable = function() {
	...
	if(queryURL.indexOf('?')==-1)
		queryURL += "?attachmentGroupId="+uploaderSelf.getAttachmentGroupId()+"&fileTypesDescription="+this.getFileTypesDescription()+"&jsoncallback=?";
	else
		queryURL += "&attachmentGroupId="+uploaderSelf.getAttachmentGroupId()+"&fileTypesDescription="+this.getFileTypesDescription()+"&jsoncallback=?";
	$.getJSON(queryURL,function(tableData) {
