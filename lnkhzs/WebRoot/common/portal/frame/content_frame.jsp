...
<html>
	...
	<FRAMESET COLS="4,230,5,*,4" border="0" framespacing="0" name="ContentFrm" id="mainFrm">
		<FRAME src="${ctx}/common/portal/frame/frame_left.jsp" scrolling="no" name="centerFrame" frameborder="0" noresize>
		<FRAME src="${ctx}/portal/left.action?menuid=${menuid}" name="leftFrame" scrolling="no" frameborder="0" noresize>
