...
<meta charset="UTF-8">
<title>溯源问题验收</title>
<script type="text/javascript" src="${ctx }/lnkhzs/trace/traceSourceListCheck.js"></script>
...
<body>
	<div class="Ct Dialog">
		...
		<dg:ajaxgrid id="table0" sqlname="SQL_ZL_TRACE_SOURCE_LIST3.query">
			<dg:lefttoolbar>
				<button class="btn-link icon iconfont fontsize14 icon-refresh2 refresh" onclick="$.bs.table.refresh('table0')">刷新</button>
				<button class="btn-link iconfont fontsize14 icon-download" onclick="exportd()">批量导出</button>
	            <button class="btn-link iconfont fontsize14 icon-upload1" onclick="openwindow('${ctx}/lnkhzs/trace/import2.jsp')">批量验收导入</button>
	            <button class="btn-link iconfont fontsize14 icon-upload1" onclick="openwindow('${ctx}/lnkhzs/trace/import4.jsp')">批量整改导入</button>
<!-- 	            <button class="btn-link iconfont fontsize14 icon-delete1"  onclick="rectify()">批量整改</button>  -->
	            <!-- <button class="btn-link iconfont fontsize14 icon-delete1"  onclick="remove()">选中删除</button>  -->
			</dg:lefttoolbar>
			<dg:condition>
		    ...
		    <div class="t-wrap">
				...
				<table id="table1" data-height='auto' data-fixed-columns='false' data-fixed-number='3' 
				 class="table table-hover text_align_center table-no-bordered" data-on-load-success="table_load_success"  data-show-columns='false'>
					<thead>
						<tr>
							...
							<th data-field="LINK_PROGRESS"  data-sortable="true">环节进展</th>
                            ...
                            <th data-field="CONCRETE_PROBLEMS" data-sortable="true" data-formatter="$.bs.table.fmt.link" data-events="fn_evnt_name_look" >具体问题点</th>
                            ...
                            <th data-field="LOOK_BACK_TIME" data-sortable="true">回头看发起时间</th>
                            <th data-field="ID" data-sortable="true">ID</th>
                            <th data-field="NETWORK3_ID" data-sortable="true">市场三级网格ID</th>
                            <th data-field="NETWORK3_NAME" data-sortable="true">市场三级网格名称</th>
