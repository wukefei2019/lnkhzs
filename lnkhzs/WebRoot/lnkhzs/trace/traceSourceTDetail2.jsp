...
<script type="text/javascript" src="${ctx }/lnkhzs/trace/traceSourceTDetail2.js"></script>
...
<body>
	<div class="Ct Dialog">
		...
		<dg:ajaxgrid id="table0" sqlname="SQL_ZL_TRACE_SOURCE_TDETAIL2.query">
			<dg:lefttoolbar>
				<button class="btn-link icon iconfont fontsize14 icon-refresh2 refresh" onclick="$.bs.table.refresh('table0')">刷新</button>
			</dg:lefttoolbar>
			<dg:condition>
				<input type="hidden" id="loginname" name="loginname" value="<%=user.getLoginName() %>"/>
