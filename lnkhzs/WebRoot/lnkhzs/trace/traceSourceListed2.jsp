...
<meta charset="UTF-8">
<title>溯源问题处理-已办</title>
<script type="text/javascript" src="${ctx }/lnkhzs/trace/traceSourceListed2.js"></script>
</head>
<body>
	<div class="Ct Dialog">
		<eoms:menuway id="${navid }"></eoms:menuway>
		<dg:ajaxgrid id="table0" sqlname="SQL_ZL_TRACE_SOURCE_STATISTICS.query">
			<dg:lefttoolbar>
				...
				<table id="table1" data-height='auto' data-fixed-columns='false' data-fixed-number='3' 
					...
					<thead>
						<tr>
							...
							<th data-field="CODE" data-formatter="$.bs.table.fmt.link" data-events="fn_evnt_name_look" data-sortable='true'>序号</th>
