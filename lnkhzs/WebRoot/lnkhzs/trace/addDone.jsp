...
<head>
<meta charset="UTF-8">
	<title>完成</title> <!--<style type='text/css'>
</style> -->
	...
	<div class="Ct Dialog contract form-page">
		<div class='panel panel-primary'>
			<div class='panel-heading'>
				...
				<a class='btn floatRight10' onclick='finish()'>完成</a>
			</div>
			<iframe name="frm" src="" style="display:none" id="frm"></iframe>
				<form id='form' name='form' target="frm" class="collapse in">
					...
					<input type="hidden" name="actionStr"	value="完成" />
					<div class="form-table">
						<div class="row" style="margin-left: 0px;margin-right: 0px;">
							...
							<div class='col-xs-3'>
								<input id="lookBackTime" type='date'  name='traceSourceList.lookBackTime'   class='form-control width160 beginDate' onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',onpicked:func_my97_picked });"  value="${fn:substring(traceSourceList.lookBackTime,0,10)}"/>
							</div>
							<div class='col-xs-3'>
								<label>市场三级网格ID：</label>
							</div>
							<div class='col-xs-3'>
								<input id="network3Id" type='text'  class='form-control'	name='traceSourceList.network3Id' value="${traceSourceList.network3Id}" />
							</div>
							<div class='col-xs-3'>
								<label>市场三级网格名称：</label>
							</div>
							<div class='col-xs-3'>
								<input id="network3Name" type='text'  class='form-control'	name='traceSourceList.network3Name'  value="${traceSourceList.network3Name}" />
							</div>
							<div class='col-xs-3'>
								<label>ID：</label>
							</div>
							<div class='col-xs-3'>
								<input id="id" type='text'  class='form-control'	name='traceSourceList.id' value="${traceSourceList.id}" />
							</div>
							<div class='col-xs-3'>
