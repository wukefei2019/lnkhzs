...
<script type='text/javascript'>
	...
	function getTags(A12) {
		$("#labelcategory").val(A12);
		/* var url = $ctx + "/tsgd/resend/getInfo.action?A12="+A12;
		$.post(url).done(function(data) {
...
<body>
	<div class="Ct Dialog contract form-page">
		<div id="formTable" style="margin-top: 10px;" class='panel panel-primary'>
			...
			<form id='form' name='form' target="frm" class="collapse in">
				...
				<div class="form-table">
					...
					<div class='col-xs-9'>
						<input id="mattercategory" type='text' style="width: 30%"
					...
					<div class='col-xs-9'>
						<textarea id="applytitle" type='text' style="width: 100%"
							class='txtarea1' name='wFresend.applytitle'
							value='${wFresend.applytitle}' ></textarea>
					</div>
					</div>
					<div class="row" style="margin-left: 0px;margin-right: 0px;">
					<div class='col-xs-3'>
					...
					<div class='col-xs-9'>
						<textarea id="content" type='text' style="width: 100%"
							class='txtarea1' name='wFresend.content'
							value='${wFresend.content}' ></textarea>
					</div>
					</div>
					<div class="row" style="margin-left: 0px;margin-right: 0px;">
					<div class='col-xs-3'>
					...
					<div class='ygts col-xs-9'>
						<select id="validmethod" style="width: 30%" class='form-control'
					...
					<div class='col-xs-9'>
						<input id="validvalue" type="number" style="width: 30%"
