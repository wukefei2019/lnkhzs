...
<html>
	<head>
		<meta charset="UTF-8">
		<title>部门主管配置信息</title>
        <script type="text/javascript" src="${ctx }/lnkhzs/khzs/depAdmin.js"></script>
...
<eoms:menuway id="${navid }"></eoms:menuway>
 <dg:ajaxgrid id="table0" sqlname="SQL_KHZS_DEPADMIN.query" inmap="${inmap }">
            <dg:lefttoolbar>
                ...
                <table data-height='auto' data-fixed-columns='false' data-fixed-number='3' class="table table-hover text_align_center table-no-bordered" data-show-columns='false'>
                    <thead>
                        <tr>
                            ...
                            <th data-field="DEPID" data-visible='false' >机构pid</th>
                            <th data-field="DEPNAME" data-sortable='true'>机构名称</th>
                            <th data-field="DEPFULLNAME" data-sortable='true'>机构全名</th>
                            <th data-field="DEPCODE" data-visible='false' data-sortable='true'>部门编码（或存外系统部门id）</th>
                            <th data-field="LOGINNAME" data-visible='false' data-sortable='true'>登录名唯一</th>
                            <th data-field="FULLNAME" data-sortable='true'>用户中文名</th>
