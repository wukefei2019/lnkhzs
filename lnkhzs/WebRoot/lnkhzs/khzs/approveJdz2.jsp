...
/*     		savepath:'eoms_workSheet/WF4_EL_UVS_TSK/2021-01-18' */
    ...
    function fn_save() {
        ...
        var url =encodeURI($ctx + "/khzs/flow/khzsTFlowAction/doAction.action?khzsTFlow.remark="
        		...
        		+"&khzsTMain.isSketch="+$("#isSketch").val());
        		...
        		<div id="approve" class='panel panel-primary'>
	                <div class='panel-heading'>
	                    <h3 class='panel-title'>
	                    	...
	                    	<a class='btn floatRight10 handOut' style='display: none'>评价</a>
						</h3> 
	                </div>
	                ...
	                <div class="form-table">
		                <div class='col-xs-3'>
							<label class="required">是否钻石点子：</label>
						</div>
						<div class='col-xs-9'>
							<select id="isSketch" style="width:100%" class='form-control' name='khzsTMain.isSketch' >
								<option ></option>
                   ...
                   <form id='form' name='form'target="frm" class="collapse in">
					...
					<div class="form-table">
						...
						<div class='col-xs-9'>
							...
							uploadBtnIsVisible="false" progressIsVisible="true" uploadable="false"
