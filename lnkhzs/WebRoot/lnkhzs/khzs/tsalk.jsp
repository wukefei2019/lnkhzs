...
<html>
	<head>
		<meta charset="UTF-8">
		<title>客户之声信息</title>
        <script type="text/javascript" src="${ctx }/lnkhzs/khzs/tsalk.js"></script>

 </head>
<body>
<div class="Ct Dialog">
<eoms:menuway id="${navid }"></eoms:menuway>
 <dg:ajaxgrid id="table0" sqlname="SQL_KHZS_TSALK.query">
            <dg:lefttoolbar>
                ...
                <table data-height='auto' data-fixed-columns='false' data-fixed-number='3' class="table table-hover text_align_center table-no-bordered" data-show-columns='false'>
                    <thead>
                        <tr>
                            ...
                            <th data-field="QUESTIONTYPE" data-sortable='true'>投诉类型</th>
                            <th data-field="DESCRIPTION" data-sortable='true'>投诉案例描述</th>
                            <th data-field="SOURCE" data-sortable='true'>投诉案例描述</th>
