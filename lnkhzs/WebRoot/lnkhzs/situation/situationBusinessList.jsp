...
<html>
	<head>
        ...
        <script type="text/javascript" src="${ctx}/lnkhzs/situation/situationBusinessList.js"></script>
...
<body>
	<div class="Ct Dialog">
		...
		<dg:ajaxgrid id="table0" sqlname="SQL_TS_BM.query">
		<dg:lefttoolbar>
				<button
		...
		<dg:ajax-table>
			...
			<thead>
				<tr class="tr1">
					...
					<th rowspan="2" data-field="GY_COMPLANTS">业务营销广义投诉量</th> 
					<th rowspan="2" data-field="ZX_COMPLANTS">业务营销在线抱怨量</th>
					<th colspan="2">业务营销狭义投诉情况</th>
				</tr>
				<tr class='tr1'>
