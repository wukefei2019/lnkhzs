...
<meta charset="UTF-8">
	...
	<script type="text/javascript"
		src="${ctx }/lnkhzs/situation/situationCHBNInList.js"></script>
...
<body>
	<div class="Ct Dialog">
		...
		<dg:ajaxgrid id="table0" sqlname="SQL_TS_TS_CHBN_IN.query">
			<dg:lefttoolbar>
				<button
				...
				<table data-height='auto' data-fixed-columns='false'
					...
					<thead>
						...
						<tr>
							...
							<th colspan="7">总体情况</th>
							<th colspan="7">答疑工单</th>
							<th colspan="12">体验需求工单一</th>
							<th colspan="7">体验工单需求二</th>
							<th colspan="7">体验感知协查工单一</th>
							<th>体验感知协查工单二</th>
						</tr>
						<tr>
							...
							<th data-field="TOTAL_MARKET_RAT">市场类占比</th>
							<th data-field="TOTAL_NET">其中：网络类</th>
							<th data-field="TOTAL_NET_RAT">网络类占比</th>
							<th data-field="TOTAL_XA">其中：信安类</th>
							<th data-field="TOTAL_XA_RAT">信安类占比</th>
							
							<th data-field="ANSWER_TOTAL">总量</th>
							<th data-field="ANSWER_MARKET">其中：市场类</th>
							<th data-field="ANSWER_MARKET_RAT">市场类占比</th>
							<th data-field="ANSWER_NET">其中：网络类</th>
							<th data-field="ANSWER_NET_RAT">网络类占比</th>
							<th data-field="ANSWER_XA">其中：信安类</th>
							<th data-field="ANSWER_XA_RAT">信安类占比</th>
							...
							<th data-field="NEED_FIRST_MARKET">其中：市场类工单数量</th>
							<th data-field="NEED_FIRST_MARKET_RAT">市场类占总量比</th>
							<th data-field="NEED_FIRST_MARKET_TRE">市场类中-体验需求工单量三数量</th>
							<th data-field="NEED_FIRST_NET">其中：网络类工单数量</th>
							<th data-field="NEED_FIRST_NET_RAT">网络类占总量比</th>
							<th data-field="NEED_FIRST_NET_TRE">网络类中-体验需求工单量三数量</th>
							<th data-field="NEED_FIRST_GOVER">其中：政企类工单数量</th>
							<th data-field="NEED_FIRST_GOVER_RAT">政企类占总量比</th>
							<th data-field="NEED_FIRST_GOVER_TRE">政企类中-体验需求工单量三数量</th>
							
							<th data-field="NEED_SECOND_TOTAL">总量</th>
							<th data-field="NEED_SECOND_MARKET">其中：市场类</th>
							<th data-field="NEED_SECOND_MARKET_RAT">市场类占比</th>
							<th data-field="NEED_SECOND_NET">其中：网络类</th>
							<th data-field="NEED_SECOND_NET_RAT">网络类占比</th>
							<th data-field="NEED_SECOND_XA">其中：信安类</th>
							<th data-field="NEED_SECOND_XA_RAT">信安类占比</th>
							
							<th data-field="ASSIST_FIRST_TOTAL">总量</th>
							<th data-field="ASSIST_FIRST_MARKET">其中：市场类</th>
							<th data-field="ASSIST_FIRST_MARKET_RAT">市场类占比</th>
							<th data-field="ASSIST_FIRST_NET">其中：网络类</th>
							<th data-field="ASSIST_FIRST_NET_RAT">网络类占比</th>
							<th data-field="ASSIST_FIRST_XA">其中：信安类</th>
							<th data-field="ASSIST_FIRST_XA_RAT">信安类占比</th>
							
							<th data-field="ASSIST_SECOND_TOTAL">总量</th>
