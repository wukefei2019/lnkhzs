...
<html>
	<head>
        ...
        <script type="text/javascript" src="${ctx}/lnkhzs/situation/situationUnknownList.js"></script>
...
<body>
	<div class="Ct Dialog">
		...
		<dg:ajaxgrid id="table0" sqlname="SQL_TS_UN.query">
		<dg:lefttoolbar>
				<button
		...
		<dg:ajax-table>
			...
			<thead>
				<tr class="tr1">
					...
					<th rowspan="2" data-field="GY_COMPLANTS">广义不知情定制投诉量</th> 
					<th rowspan="2" data-field="ZX_COMPLANTS">不知情定制在线抱怨量</th>
					<th colspan="2">不知情定制狭义投诉情况</th>
				</tr>
				<tr class='tr1'>
