...
<html>
	<head>
        ...
        <script type="text/javascript" src="${ctx}/lnkhzs/situation/situationPhoneList.js"></script>
...
<body>
	<div class="Ct Dialog">
		...
		<dg:ajaxgrid id="table0" sqlname="SQL_TS_SJSW.query">
		<dg:lefttoolbar>
				<button
		...
		<dg:ajax-table>
			...
			<thead>
				<tr class="tr1">
					...
					<th rowspan="2" data-field="GY_COMPLANTS">4G手机上网广义投诉量</th> 
					<th rowspan="2" data-field="ZX_COMPLANTS">4G手机上网在线抱怨量</th>
					<th colspan="2">4G手机上网狭义投诉情况</th>
				</tr>
				<tr class='tr1'>
					<th  data-field="XY_COMPLANTS">狭义投诉量</th>
