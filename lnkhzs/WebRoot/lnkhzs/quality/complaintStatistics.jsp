...
<html>
	<head>
		<meta charset="UTF-8">
		<title>投诉分类统计表</title>
        <script type="text/javascript" src="${ctx }/lnkhzs/quality/complaintStatistics.js"></script>
 </head>
<body>
<div class="Ct Dialog">
<input sqltablename="NGCS_WF_CMPLNTS_ARC_DETAIL" id="tablename" style="display: none;"/>
<eoms:menuway id="${navid }"></eoms:menuway>
 <dg:ajaxgrid id="table0" sqlname="SQL_COMPLAINT_STATISTICS.query" inmap="${inmap }" autoLoad="false">
