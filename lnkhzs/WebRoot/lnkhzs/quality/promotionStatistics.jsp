...
<script type="text/javascript" src="${ctx }/lnkhzs/quality/zPromotionCom.js"></script>
<html>
	<head>
		<meta charset="UTF-8">
		<title>升级工单分类统计表</title>
        <script type="text/javascript" src="${ctx }/lnkhzs/quality/promotionStatistics.js"></script>
 </head>
<body>
<div class="Ct Dialog">
<input sqltablename="NGCS_WF_CMPLNTS_ARC_DETAIL_SJ" id="tablename" style="display: none;"/>
<eoms:menuway id="${navid }"></eoms:menuway>
	<dg:ajaxgrid id="table0" sqlname="SQL_QUALITY_SJ_STATISTICS.query" autoLoad="false"> <!-- conditionIsOpen="true" -->
			 		...
			 		<div class="t-toolbar">
			 			<div class="t-panels">
			 				<div class="t-panel tbar-panel-cart">
				 				...
				 				<!-- <div>
				 				<span style="margin-left: 5%;">受理渠道 ：</span>
				 					<select class="form-control" id="SLQD" name="acptChnlNm"  style=" width:50%; height:inherit;margin-top: 5px;float: right;margin-right: 75px;">
				 					<option value="" selected="selected"></option>
					 				</select>
				 				</div>
				 				<div>
				 				<span style="margin-left: 5%;">用户星级 ：</span>
				 					<select class="form-control" id="YHXJ" name="custStargrdNm" style=" width:50%; height:inherit;margin-top: 5px;float: right;margin-right: 75px;">
				 					<option value="" selected="selected"></option>
					 				</select>
				 				</div> -->
				 				
				 				<ul id="tree1s" class="ztree" style="width:100%; height:inherit;margin-top: 0px;border: inherit">
				 				</ul>
