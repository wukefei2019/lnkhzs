...
<html>
	<head>
		<meta charset="UTF-8">
		<title>升级工单明细日报表</title>
		<script type="text/javascript" src="${ctx }/lnkhzs/quality/promotionList.js"></script>
 	</head>
	<body>
		<div class="Ct Dialog">
			<eoms:menuway id="${navid }"></eoms:menuway>
			<dg:ajaxgrid id="table0" sqlname="SQL_QUALITY_SJ.query" autoLoad="false"> <!-- conditionIsOpen="true" -->
	 			<dg:condition>
	                    ...
	                    <thead>
	                        <tr>
	                           ...
	                           <!--  <th data-field="ACPT_NUM">受理号码 </th>
	                            ...
	                            <th data-field="CUST_STARGRD_NME" data-sortable='true'>用户星级</th>
	                            ...
	                            <th data-field="TOTAL_TIME2" data-sortable='true'>处理时长(含夜间)  </th>
	                            <th data-field="TOTAL_TIME3" data-sortable='true'>处理时长  </th>
	                            <th data-field="NO1" data-sortable='true'>前期10086投诉次数  </th>
	                            <th data-field="NO2" data-sortable='true'>前期涉及10086渠道工单流水 </th>
	                            <th data-field="NO3" data-sortable='true'>前期10086渠道处理人员  </th>
	                            <th data-field="NO5" data-sortable='true'>是否省内结单  </th>
	                            <th data-field="CREATE_TIME" data-sortable='true'>入库时间  </th>
	                        </tr>
	                    </thead>
	                </table>
	            </dg:ajax-table>
