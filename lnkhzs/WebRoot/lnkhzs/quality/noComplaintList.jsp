...
<html>
	<head>
		<meta charset="UTF-8">
		<title>非投诉结单归档量明细</title>
        <script type="text/javascript" src="${ctx }/lnkhzs/quality/noComplaintList.js"></script>
 </head>
<body>
<div class="Ct Dialog">
<eoms:menuway id="${navid }"></eoms:menuway>
 <dg:ajaxgrid id="table0" sqlname="SQL_NO_COMPLAINT.query" autoLoad="false">
            <dg:condition>
                ...
                <table data-show-columns="true" id="table1" data-height='auto' data-fixed-columns="false" data-fixed-number="3" data-on-load-success="table_load_success"
	                ...
	                <thead>
                        <tr>
                            ...
                            <th data-field="START_SC_DURATION" data-sortable='true'>首次咨询响应时长</th>
                        </tr>
                    </thead>
                </table>
            </dg:ajax-table>
