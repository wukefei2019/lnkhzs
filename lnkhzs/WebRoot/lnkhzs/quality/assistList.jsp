...
<html>
	<head>
		<meta charset="UTF-8">
		<title>协查工单结单归档量明细</title>
        <script type="text/javascript" src="${ctx }/lnkhzs/quality/assistList.js"></script>
 </head>
<body>
<div class="Ct Dialog">
<eoms:menuway id="${navid }"></eoms:menuway>
 	<dg:ajaxgrid id="table0" sqlname="SQL_ASSIST.query" inmap="${inmap }"  autoLoad="false">
           <%--  <dg:lefttoolbar>
                ...
                <table data-show-columns="true" id="table1" data-height='auto' data-fixed-columns='false' data-fixed-number='3' data-on-load-success="table_load_success"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-field="A01" data-sortable='true'>服务请求类别</th>
                            ...
                            <th data-field="A02" data-sortable='true'>短信回访满意度</th>
                            <th data-field="DSPS_OPIN_CNTT" data-formatter="fmt_operate_dxyj" data-sortable='true'>短信意见</th>
                            <th data-field="STAFF_ID4" data-sortable='true'>结束处理人</th>
                            <th data-field="GROUP_NAME4" data-sortable='true'>结束工作组</th>
                            <th data-field="FDBK_MODE" data-sortable='true'>回复方式</th>
                            <th data-field="ARC_TIME" data-sortable='true'>结单日期</th>
                            <th data-field="LAST_CUST_SATIS" data-sortable='true'>回复满意度</th>
                            <th data-field="RESP_DEPT" data-sortable='true'>负责部门</th>
                            <th data-field="RESP_RNS_NM" data-sortable='true'>负责原因</th>
                            <th data-field="OTHER_SYSTEM" data-sortable='true'>外部系统</th>
                            <th data-field="N_SATIS_RSN_DESC" data-sortable='true'>不满意原因</th>
                            <th data-field="CMPGN_NM" data-sortable='true'>用户参加的营销活动</th>
                            <th data-field="TOTAL_TIME" data-sortable='true'>处理时长</th>
                            <th data-field="CNTWAY" data-sortable='true'>联系方式</th>
                            <th data-field="RSLV_EXTENT" data-sortable='true'>解决程度</th>
                            <th data-field="STAFF_ID0" data-sortable='true'>真实处理人</th>
                            ...
                            <th data-field="A03" data-sortable='true'>疑难客户类型</th>
                            ...
                            <th data-field="A04" data-sortable='true'>工单回访标志</th>
                            ...
                            <th data-field="GROUP_NAME0" data-sortable='true'>真实处理工作组</th>
                            <th data-field="ORG_BRNCH" data-sortable='true'>目标机构</th>
                            <th data-field="PRE_WORKITEM_EVAL" data-sortable='true'>首处立上环节评价</th>
                            <th data-field="OTHER_SYSTEM2" data-sortable='true'>外部系统加长版</th>
                            <th data-field="TOTAL_TIME2" data-sortable='true'>处理时长_含夜间</th>
                            <th data-field="TOTAL_TIME3" data-sortable='true'>处理时长</th>
                            <th data-field="NO1" data-sortable='true'>NO1</th>
                            <th data-field="NO2" data-sortable='true'>NO2</th>
                            <th data-field="NO3" data-sortable='true'>NO3</th>
                            <th data-field="NO4" data-sortable='true'>NO4</th>
                            <th data-field="NO5" data-sortable='true'>NO5</th>
                            <th data-field="NO6" data-sortable='true'>NO6</th>
                            <th data-field="NO7" data-sortable='true'>NO7</th>
                            <th data-field="NO8" data-sortable='true'>NO8</th>
                            <th data-field="NO9" data-sortable='true'>NO9</th>
                        </tr>
                    </thead>
                </table>
            </dg:ajax-table>
