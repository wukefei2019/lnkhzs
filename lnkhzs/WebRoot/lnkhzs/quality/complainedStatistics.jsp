...
<html>
	<head>
        ...
        <script type="text/javascript" src="${ctx }/lnkhzs/quality/complainedStatistics.js"></script>
 </head>
<body>
<div class="Ct Dialog">
<input sqltablename="NGCS_WF_CMPLNTS_REQST_DETAIL" id="tablename" style="display: none;"/>
<eoms:menuway id="${navid }"></eoms:menuway>
 <dg:ajaxgrid id="table0" sqlname="SQL_COMPLAINED_STATISTICS.query" inmap="${inmap }" autoLoad="false">
