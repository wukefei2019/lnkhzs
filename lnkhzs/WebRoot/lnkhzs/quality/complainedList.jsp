...
<html>
	<head>
		<meta charset="UTF-8">
		<title>抱怨工单明细</title>
        <script type="text/javascript" src="${ctx }/lnkhzs/quality/complainedList.js"></script>
 </head>
<body>
...
<eoms:menuway id="${navid }"></eoms:menuway>
 <dg:ajaxgrid id="table0" sqlname="SQL_COMPLAINED.query" inmap="${inmap }" autoLoad="false">
	                ...
	                class="table table-hover text_align_center table-no-bordered" data-show-columns='false'>
                        ...
                        <tr>
                         ...
                         <!--    <th data-field="CALLING_NUM">受理号码</th>
                            ...
                            <th data-field="A13" data-formatter="fmt_operate" data-sortable='true'>受理内容</th>
