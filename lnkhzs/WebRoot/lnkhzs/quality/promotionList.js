...
function getTablename() {
	var tablename = "NGCS_WF_CMPLNTS_ARC_DETAIL_SJ";
	return tablename;
}

fn_detail = {
	'click a': function (e, value, row, index) {
		openwindow($ctx + '/quality/promotion/arcDetailSj.action?sWfCmplntsArcDetailSj.wrkfmShowSwftno='+row.WRKFM_SHOW_SWFTNO,'');
   }
}

function getEndTime(){
	$.post($ctx + "/quality/promotion/getEndTime.action").done(function(result) {
