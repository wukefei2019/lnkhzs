...
<script type="text/javascript" src="${ctx }/lnkhzs/quality/serviceRequestNodeBakLab.js"></script>
...
<eoms:menuway id="${navid }"></eoms:menuway>
 	<dg:ajaxgrid id="table0" sqlname="SQL_SERVICE_REQUEST_NODE_BAK.query" inmap="${inmap }">
 	<input type='hidden' id='flowStatus' name='flowStatus' value='草稿'/>
           	<dg:lefttoolbar>
