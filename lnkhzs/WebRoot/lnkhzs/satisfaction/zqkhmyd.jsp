...
<meta charset="UTF-8">
<title>政企客户满意度调研结果统计表</title>
<script type="text/javascript" src="${ctx }/lnkhzs/satisfaction/zqkhmyd.js"></script>			
</head>
<body>
	<div class="Ct Dialog">
		<dg:ajaxgrid id="table0" sqlname="SQL_TS_ZQKHMYD.query">
			<dg:lefttoolbar>
				<button class="btn-link icon iconfont fontsize14 icon-refresh2 refresh" onclick="$.bs.table.refresh('table0')">刷新</button>
		 		<button class="btn-link iconfont fontsize14 icon-upload1" onclick="$.bs.modal.open('${ctx}/lnkhzs/satisfaction/importZqkh.jsp',width=500,height=300)">导入</button>
				...
				<table id="table1" data-height='auto' data-fixed-columns='false' data-fixed-number='3'
					...
					<thead>
                        <tr>
                        	...
                        	<th data-field="RESP_DEPT" data-sortable='true'>集团归属地市</th>
                            <th data-field="CUST_SATIS" data-sortable='true'>政企客户满意度</th>
                            <th data-field="GROUP_SATIS" data-sortable='true'>集团关键人满意度</th>
                            <th data-field="CONTACTS" data-sortable='true'>集团联系人满意度</th>
                            <th data-field="LINE_SATIS" data-sortable='true'>集团专线开通满意度</th>
                            <th data-field="OPEN_SATIS" data-sortable='true'>企业宽带开通满意度</th>
