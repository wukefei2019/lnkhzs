...
<script type="text/javascript" src="${ctx }/lnkhzs/satisfaction/jtzxktmyd.js"></script>			
</head>
<body>
	<div class="Ct Dialog">
		<dg:ajaxgrid id="table0" sqlname="SQL_TS_JTZXKTMYD.query">
			<dg:lefttoolbar>
				<button class="btn-link icon iconfont fontsize14 icon-refresh2 refresh" onclick="$.bs.table.refresh('table0')">刷新</button>
		 		<button class="btn-link iconfont fontsize14 icon-upload1" onclick="$.bs.modal.open('${ctx}/lnkhzs/satisfaction/import_jtzxktmyd.jsp',width=500,height=300)">导入</button>
				...
				<table id="table1" data-height='auto' data-fixed-columns='false' data-fixed-number='3'
					...
					<thead>
                        <tr>
                            ...
                            <th data-formatter="operate_formatter" data-field="SATIS" data-sortable='true'>专线开通满意度</th>
                            <th data-formatter="operate_formatter" data-field="TOTALSATIS" data-sortable='true'>开通整体满意度(10%)</th>
                            <th data-formatter="operate_formatter" data-field="TIMELINESS" data-sortable='true'>开通时效性(30%) </th>
                            <th data-formatter="operate_formatter" data-field="SPECIALITY" data-sortable='true'>施工专业性(30%) </th>
                            <th data-formatter="operate_formatter" data-field="PERSONSERVICE" data-sortable='true'>施工人员服务(30%)</th>
