...
function getParams() {
	...
	var params = "&area_name=" + cityName + "&time=" + dateVal + "&type=物联网卡";
...
function initCharts() {
	...
	var url = $ctx + "/standards/fwzl/ajaxGetPiesJsonInter.action?menuId=A&unit=A" + encodeURI(urlParam);
...
function addInd(){
	var urlParam = getParams();
	openwindow($ctx + "/lnkhzs/standards/indAddInter.jsp?menuId=B"+encodeURI(urlParam));
}
