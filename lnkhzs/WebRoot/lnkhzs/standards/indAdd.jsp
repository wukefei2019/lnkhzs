...
.divChartStore{
	...
	function contentDivbtn(obj){
		...
		$(document).ready(function() {
			...
			var url = $ctx + "/standards/fwzl/ajaxGetPiesJson.action?menuId=B" + encodeURI(params);
			$.post(url).done(function(data) {
				...
				for (var i = 0; i < data.length; i++) {
					...
					if (vieworder != null && vieworder > 0) {
						...
						$("#" + id).append('<div style="z-index:99;width: 100%;height: 100%;position: absolute;left: 0;top: 0;background-color: rgba(0,0,0,0);display:block;text-align:center;"><div class="addDiv"><img src="../style/image/finish.png" class="add"/></div></div>');
					}else if(value==0){
						$("#" + id).removeAttr("onclick");
						//$("#" + id).append('<div style="width: 100%;height: 100%;position: absolute;left: 0;top: 0;background-color: rgba(0,0,0,0.4);display:table;text-align:center;"><div class="addDiv"><img src="../style/image/loading_0.gif" class="add"/></div></div>');
						$("#" + id).append('<div style="z-index:99;width: 100%;height: 100%;position: absolute;left: 0;top: 0;background-color: rgba(0,0,0,0);display:block;text-align:center;"><div class="addDiv" style="color: cyan;"><span style="line-height: 260%">&nbsp;&nbsp;数据未接入</span></div></div>');
					}else {
						//$("#" + id).append('<div style="width: 100%;height: 100%;position: absolute;left: 0;top: 0;background-color: rgba(0,0,0,0.4);display:table;text-align:center;"><div class="addDiv"><img src="../style/image/loading_0.gif" class="add"/></div></div>');
					}
				}
		 ...
		 function fnSearch() {
			...
			for (var i = mynum; i < maxlength; i++) {
				...
				if (vieworder != null && vieworder > 0) {
					...
					$("#" + id).removeAttr("onclick");
					//$("#" + id).append('<div style="width: 100%;height: 100%;position: absolute;left: 0;top: 0;background-color: rgba(0,0,0,0.4);display:table;text-align:center;"><div class="addDiv"><img src="../style/image/loading_0.gif" class="add"/></div></div>');
					$("#" + id).append('<div style=" z-index:99; width: 100%;height: 100%;position: absolute;left: 0;top: 0;background-color: rgba(0,0,0,0.0);display:block;text-align:center;"><div class="addDiv" style="color: cyan;"><span style="line-height: 260%">&nbsp;&nbsp;数据未接入</span></div></div>');
				}else {
					//$("#" + id).append('<div style="width: 100%;height: 100%;position: absolute;left: 0;top: 0;background-color: rgba(0,0,0,0.4);display:table;text-align:center;"><div class="addDiv"><img src="../style/image/loading_0.gif" class="add"/></div></div>');
				}
			}
