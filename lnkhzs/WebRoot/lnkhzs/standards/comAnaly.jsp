...
<meta charset="UTF-8">
	...
	<script type="text/javascript" src="${ctx }/lnkhzs/standards/comAnaly.js"></script>
...
<body class="bodyArea">
	...
	<div class="bodyDiv">
		<div class="divsele">
			...
			</select> <label for="inputCala" class="radioY"><span>年</span></label> <label
				for="inputCala" class="radioM selected"><span>月</span></label> <input
				type="text" name="inputCala" autocomplete="off"
				class="textInput inputCala" id="calendar"
				onclick="var dateFormat=changeTime();WdatePicker({dateFmt:dateFormat,onpicked:changeDateVal});"
				value="" style="padding-bottom: 1px;">
				<button type="submit" class="btn btn-default"
					style="height: 24px;text-align: center;line-height: 4px;margin-bottom: 2px;margin-left: 2px;border-color: #cccccc6b;"
					onclick="downLoadExel()">导出</button>
		</div>
		<div class="midDiv1">
			<div class="midTitDiv">
