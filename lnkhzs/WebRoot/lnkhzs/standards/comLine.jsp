...
var area_name="";
	...
	function getLineJsonById(myChart, param, placeArr, colorArr) {
		var url = $ctx + "/standards/fwzl/ajaxGetPiesJson.action?menuId=E" + "&name="+ encodeURI(name)+"&type="+ encodeURI(type)+"&area_name="+ encodeURI(area_name);
	...
	//柱状图
		function getColuJsonById(myChart, params) {
			...
			var url = $ctx + "/standards/fwzl/ajaxGetPiesJson.action?menuId=F" + "&name="+ encodeURI(name)+"&type="+ encodeURI(type)+"&time="+time;
			$.post(url).done(function(dataArr) {
				var data = dataArr;
				var nameTemp = new Array();
				var valueTemp = new Array();
