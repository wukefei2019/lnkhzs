...
<script type='text/javascript'>
	$(document).ready(function() {
		$(".btn-link.icon-roundadd").on("click", function(event) {
			openwindow($ctx + '/lnkhzs/propage/editManager.jsp');
		});
	});
...
<meta charset="UTF-8">
<title>管理员配置</title>
<script type="text/javascript" src="${ctx }/lnkhzs/propage/resendManager.js"></script>
</head>
<body>
	<div class="Ct Dialog">
		<eoms:menuway id="${navid }"></eoms:menuway>
		<dg:ajaxgrid id="table0" sqlname="SQL_KHZS_MANAGER.query">
			<dg:lefttoolbar>
