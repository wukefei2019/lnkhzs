	...
	<div id="bpp_Header">
		...
		<div id="bpp_ExtendLinks">
			<c:if test="${displayCxt.editType=='MODIFY'}">
				...
				<span id="bpp_SaveTemplate"><a href="javascript:void(0);" onclick="openTemplateInfo();">保存模版</a></span>
				<span id="bpp_LoadTemplate"><a href="javascript:void(0);" onclick="loadTemplate();">加载模版</a></span>
		</div>
