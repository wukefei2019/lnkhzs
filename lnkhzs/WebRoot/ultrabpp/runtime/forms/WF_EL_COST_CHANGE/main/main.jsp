...
<ubf:PanelGroup name="PG_Main" cell="4" type="tab" visiable="1" showtitle="1">
	<ubf:Panel name="Txt_INCContentTitle" label="工单信息" visiable="1">
		...
		<ubf:CharacterField name="groundOrigCost" label="场地费原值" row="1" cell="1" visiable="1" length="500" />
		<ubf:CharacterField name="newGroundOrigCost" label="场地费新值" row="1" cell="1" visiable="1" length="500" />
		<ubf:CharacterField name="rate" label="租赁费增长率" row="1" cell="1" visiable="1" length="500" />
		...
		<ubf:AttachmentField name="AttachmentsList" label="附件列表" types="*.*" visiable="1">
			<atta:fileupload id="AttachmentsList_tag"
		      ...
		      displayAllAtt="self" baseSchema="WF_EL_COST_CHANGE" baseID="${AttachmentsList_baseID}" 
		      templateID=""
	...
	<ubf:Panel name="DealDescPanelField" label="流程记录" visiable="1">
		<ubf:ViewField name="DealInfoViewField"  row="30" cell="4" type="frame" visiable="1" url="${ctx}/workflow/sheet/query/BaseInfoViewBpp.jsp?baseschema=${displayCxt.baseSchema}null=${displayCxt.baseID}=${displayCxt.defCode}"/>
	</ubf:Panel>
</ubf:PanelGroup>
