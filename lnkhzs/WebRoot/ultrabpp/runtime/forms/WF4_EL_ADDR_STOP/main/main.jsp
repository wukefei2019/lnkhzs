...
<ubf:PanelGroup name="PG_Main" cell="4" type="tab" visiable="1" showtitle="1">
	<ubf:Panel name="Txt_INCContentTitle" label="工单信息" visiable="1">
		...
		<ubf:CharacterField name="site_name" label="站址名称" row="1" cell="1" visiable="1" length="2000" />
		<ubf:TimeField name="stopTime" label="停租生效时间" row="1" cell="1" visiable="1" format="yyyy-MM-dd"  />
		<ubf:CharacterField name="remarks" label="停租原因" row="3" cell="4" visiable="1" length="3000" />
		...
		<ubf:AttachmentField name="AttachmentsList" label="附件列表" types="*.*" visiable="1">
			<atta:fileupload id="AttachmentsList_tag"
		      ...
		      displayAllAtt="self" baseSchema="WF4_EL_ADDR_STOP" baseID="${AttachmentsList_baseID}" 
		      templateID=""
				flashUrl="${ctx}/ultrabpp/runtime/clientframework/component/SpecialField/AttachmentField/js/swfupload.swf" >
			</atta:fileupload>
		</ubf:AttachmentField>
		<ubf:HiddenField name="site_code" label="站址ID" cell="1" length="500" />
