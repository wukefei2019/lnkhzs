...
<ubf:PanelGroup name="PG_Main" cell="4" type="tab" visiable="1" showtitle="1">
	<ubf:Panel name="Txt_INCContentTitle" label="工单信息" visiable="1">
		...
		<ubf:CharacterField name="site_name" label="站址名称" row="1" cell="1" visiable="1" length="500" />
		<ubf:TimeField name="startTime" label="起租生效时间" row="1" cell="1" visiable="1" format="yyyy-MM-dd"  />
		...
		<ubf:HiddenField name="site_code" label="站址ID" cell="1" length="200" />
		...
		<ubf:AttachmentField name="AttachmentsList" label="附件列表" types="*.*" visiable="1">
			<atta:fileupload id="AttachmentsList_tag"
		      ...
		      displayAllAtt="self" baseSchema="WF4_EL_NEW_ADDR" baseID="${AttachmentsList_baseID}" 
		      templateID=""
