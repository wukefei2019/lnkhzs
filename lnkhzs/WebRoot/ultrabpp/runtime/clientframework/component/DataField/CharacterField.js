...
//		$("#" + this.fieldID).attr("readonly", "false");
		$("#" + this.fieldID).removeAttr("readonly");
	}
...
CharacterField.popup = function(srcID, title, content, editable)
{
	...
	*/
	...
	$("#bpp_CharacterExtendBox").width(maxWidth);
	$("#bpp_CharacterExtendBox").height(maxHeight);
	$("#bpp_CharacterExtendBox_textarea").height($("#bpp_CharacterExtendBox_content").height());
